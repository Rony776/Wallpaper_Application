...
public class CategoryFragment extends Fragment {
    ...
    DatabaseReference c_background;
    ...
    public CategoryFragment() {
        ...
        c_background = database.getReference(Common.STR_CATEGORY_BACKGROUND);


        options = new FirebaseRecyclerOptions.Builder<CategoryItem>()
                .setQuery(c_background,CategoryItem.class).build();
            ...
            protected void onBindViewHolder(@NonNull final CategoryViewHolder holder, int position, @NonNull final CategoryItem model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        Common.SELECTED_CATEGORY_ID = adapter.getRef(position).getKey();
                        Common.SELECTED_CATEGORY = model.getName();
